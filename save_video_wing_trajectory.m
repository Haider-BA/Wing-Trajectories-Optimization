function save_video_wing_trajectory( x, n , R, c_bar, num, F)

vidObj = VideoWriter('wing motion.avi');
open(vidObj);
...
global  point1_x_LE point1_z_LE point2_x_TE point2_z_TE point3_x_TE point3_z_TE
       ...
       for j = n/100:n/100:(n/2);
            ...
            plot(point1_x_LE,point1_z_LE,'k')
